...
class InheritedCustomerPortal(CustomerPortal):
    ...
    OPTIONAL_BILLING_FIELDS = ["zipcode", "state_id", "vat", "company_name",
        ...
        , 'operation_type', 'opr_id', 'tr_no', 'middlename', 'lastname', 'is_still']
...
class WebsiteHrRecruitment(Home):
    ...
    def _get_applicant_char_fields(self):
        ...
        return ['middlename', 'lastname', 'gender', 'place_of_birth',
                'country_of_birth_lt', 'marital',
                'partner_mobile', 'email_from', 'ref_name', 'ref_org',
                'ref_rel', 'ref_contact', 'is_same_address',
...
replace
        ...
        vals = {
            ...
            'partner_name': kwargs.get('firstname') + " " + kwargs.get('middlename') + " " + kwargs.get(
                'lastname') or '',
        ...
        if kwargs.get('country_id', False) not in ['', False]:
            country = int(kwargs.get('country_id'))
        ...
        vals['identification_id'] = kwargs.get('job_id')
        ...
        vals['country_of_birth_lt'] = kwargs.get('country_of_birth_lt')
        partner.write({'middlename': kwargs.get('middlename'), 'lastname': kwargs.get('lastname'),
                       'city': kwargs.get('city'), 'street': kwargs.get('street'),
        ...
        applicant_id = env['hr.applicant'].sudo().create(vals).id
...
class WebsiteInherit(odoo.addons.web.controllers.main.Home):
    ...
    def edit_certification_applicant(self, **kwargs):
        ...
        if kwargs.get('is_still'):
            ...
            vals.update({'is_still': False})
        request.env['hr.certification'].sudo().browse(int(kwargs.get('id'))).write(vals)
        return int(kwargs.get('id'))
