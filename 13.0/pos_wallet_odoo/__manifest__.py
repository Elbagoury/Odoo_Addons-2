...
This Module allow the seller to recharge wallet for the customer. point of sales wallet management , wallet in pos , wallet point of sale 
    odoo POS Customer Wallet Management
    odoo POS Wallet Management
    odoo point of sale Wallet Management
    odoo point of sales Wallet management
    odoo Customer Wallet payment with POS
    odoo Customer wallet POS
    odoo customer credit POS
    odoo POS customer credit payment    
    odoo POS Customer Wallet payment Management
    odoo POS Wallet payment Management
    odoo point of sale Wallet payment Management
    odoo point of sales Wallet payment management
    odoo wallet on POS
    odoo wallet on point of sale
...
This Module allow the seller to recharge wallet for the customer. 
    ...
    "auto_install": False,
    "installable": True,
    'live_test_url':'https://youtu.be/G91ZKBTQL2Y',
