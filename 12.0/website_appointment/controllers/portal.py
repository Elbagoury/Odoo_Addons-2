...
class PortalAccount(CustomerPortal):
    ...
    def portal_my_appointment_detail(self, appoint_id=None, access_token=None, **kw):
        ...
        # for payment mode
        payment_mode = request.env['ir.default'].sudo().get('appointment.config.settings', 'website_appoint_payment_mode')
        values.update({'payment_mode' : payment_mode if payment_mode else False, })
